...
git clone --depth 1 https://github.com/maxlicheng/luci-app-unblockmusic.git && mv luci-app-unblockmusic/app ./luci-app-unblockmusic && mv luci-app-unblockmusic/UnblockNeteaseMusic ./ && mv luci-app-unblockmusic/UnblockNeteaseMusicGo ./ && rm -rf luci-app-unblockmusic
